...
アフィリエイトシステムＰＲＯ２　設置マニュアル

Regist 2010/10/26

**************************************************************

弊社、アフィリエイトシステムＰＲＯ２をご購入頂き有難う御座います。
...
１．「afl_pro2_***.zip」を解凍ソフトで解凍を行って頂き
...
広告認証形式にcookie(3rd)を使用する場合は以下の設定が必要となります。
※Cookie(1st)を使用する場合は影響はありません。

Internet Explorer等、一部のブラウザでは、p3p プライバシーポリシーの設定が正しくない場合、
