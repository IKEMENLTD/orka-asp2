...
/*
�Ereport�쐬�p���W���[��
 $_GET['type']�����݂���ꍇ�́A����DB��tdb���e�����̂܂܎擾���ĕԂ��B
 $_GET['case']�����݂���ꍇ�́A/module/Report.inc�Œ�`���ꂽ�`����report���o�͂���B
...
*/
	...
	if ($loginUserType == $NOT_LOGIN_USER_TYPE) {
	    ...
	    if( ! $rp->user_type_check($loginUserType) ){
	        ...
	        if( isset($_POST['m']) && isset($_POST['y']) && strlen($_POST['m']) && strlen($_POST['y']) && is_numeric($_POST['y']) && is_numeric($_POST['m']) ){//���ԃf�[�^�g���āAsearch�������ʂ�CVS�ɏo��
